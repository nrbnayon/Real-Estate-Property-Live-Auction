...
Be helpful, knowledgeable about real estate investing, and specific to Arizona markets. Keep responses concise but informative.`,
      ...
      while (true) {
        ...
        if (done) {
          console.log(
            "Stream complete. Total content length:",
      ...
      if (error instanceof Error) {
        if (
          ...
          setHasApiKey(false);
          errorContent =
            "The AI service is not properly configured. Please check that your GROQ_API_KEY is set correctly in .env.local and restart the development server.";
        } else if (
          ...
          errorContent =
            "The AI service encountered an internal error. Check the console logs and verify your GROQ_API_KEY is valid.";
